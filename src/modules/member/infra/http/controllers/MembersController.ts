...
export default class MembersController {
  public async createMember(request: Request, response: Response): Promise<Response> {
    try{
  ...
  public async showMember(request:Request, response:Response): Promise<Response> {
